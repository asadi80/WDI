      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            reference wafers with advanced analytics
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <Link href="/wafer-position" className="group">
          ...
          <Link href="/wafer-sessions" className="group">
            <div className="bg-gradient-to-br from-blue-50 to-pink-50 rounded-2xl border-2 border-blue-200 shadow-sm p-6">
              <div className="flex items-center justify-between mb-2">
                <div className="text-sm font-medium text-blue-600 uppercase tracking-wide">
                  Wafer Position with EDX
                </div>
              ...
              <div className="text-lg font-semibold text-blue-900 mt-2">
                Wafer Position Check with Plan
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/upload" className="group">
              <div className="bg-white rounded-2xl border-2 border-gray-200 hover:border-orange-400 shadow-sm hover:shadow-xl p-8 transition-all duration-200 h-full">
                ...
                <p className="text-gray-600 text-sm">
                  Import Excel CU EDX inspection files and add to reference
                  database
                </p>
            ...
            <Link href="/upload-nc" className="group">
              <div className="bg-white rounded-2xl border-2 border-gray-200 hover:border-green-400 shadow-sm hover:shadow-xl p-8 transition-all duration-200 h-full">
                ...
                <p className="text-gray-600 text-sm">
                  Import Excel NC EDX inspection files and add to reference
                  database
                </p>
            ...
            <Link href="/compare" className="group">
              <div className="bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-400 shadow-sm hover:shadow-xl p-8 transition-all duration-200 h-full">
                ...
                <p className="text-gray-600 text-sm">
                  Match new wafers against reference database using advanced
                  pattern matching
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Interactive visualization of defect locations with precise
                  spatial coordinates
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Categorize and analyze defects by elemental composition
                  patterns
                </p>
              </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-300">
                  Upload your CU or NC reference wafer data using Excel files
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p className="text-gray-300">
                  Browse and analyze wafer maps with EDX defect visualization
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p className="text-gray-300">
                  Compare new wafers to find matching patterns in your database
                </p>
              </div>
            </div>
          </div>
